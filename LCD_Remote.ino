...
bitWrite(Ble_8Bit2,4,0); //saving mode off
  ...
  switch(s_value){
case 1: Mode = "A";   bitWrite(Ble_8Bit2, 5, 1); 
 Saving_Mode = 0;
       bitWrite(Ble_8Bit2,4,0);  //saving mode off
Serial.printf("*********************Mode Auto select in Lcd\n\n");
 break; // auto on
case 2: Mode = "C"; bitWrite(Ble_8Bit2,7,0); bitWrite(Ble_8Bit2,6,0); 
bitWrite(Ble_8Bit2,5,0); // Auto off
Serial.printf("*********************Mode Cooling select in Lcd\n\n"); 
break;
case 3: Mode = "F";  bitWrite(Ble_8Bit2, 7, 1);  bitWrite(Ble_8Bit2, 6, 1); 
 bitWrite(Ble_8Bit2,5,0); // Auto off
  Saving_Mode = 0;
  bitWrite(Ble_8Bit2,4,0);  //saving mode off
Serial.printf("*********************Mode Fan select in Lcd\n\n");
break; // mode fan new bit
case 4: Mode = "H"; bitWrite(Ble_8Bit2,7,0); bitWrite(Ble_8Bit2,6,1);
 bitWrite(Ble_8Bit2,5,0); // Auto off
Serial.printf("*********************Mode Heat select in Lcd\n\n");
 break;
case 5: Mode = "D"; bitWrite(Ble_8Bit2,7,1); bitWrite(Ble_8Bit2,6,0);
 bitWrite(Ble_8Bit2,5,0); // Auto off
  Saving_Mode = 0;
  bitWrite(Ble_8Bit2,4,0);  //saving mode off
...
default: break;
  ...
  s_value=4*bitRead(Control_Screen.control_screen,8)+2*bitRead(Control_Screen.control_screen,7)+bitRead(Control_Screen.control_screen,6);
    switch(s_value){
case 1: Fan_Status = "L"; bitWrite(Ble_8Bit1, 5, 0);  bitWrite(Ble_8Bit1, 4, 0);  bitWrite(Ble_8Bit1, 3, 1); break;
case 2: Fan_Status = "M"; bitWrite(Ble_8Bit1, 5, 0);  bitWrite(Ble_8Bit1, 4, 1);  bitWrite(Ble_8Bit1, 3, 0); break;
case 3: Fan_Status = "H"; bitWrite(Ble_8Bit1, 5, 0);  bitWrite(Ble_8Bit1, 4, 1);  bitWrite(Ble_8Bit1, 3, 1); break;
case 4: Fan_Status = "A"; bitWrite(Ble_8Bit1, 5, 1);  bitWrite(Ble_8Bit1, 4, 0);  bitWrite(Ble_8Bit1, 3, 0); break;
default: break;
  }
